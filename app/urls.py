...
from .views import indexKasir,indexAdmin,indexUser,logout_view,login_view, tambahMenu,editMenu,hapusMenu,laporanAdmin,kasiran,pesanan,tabelKasir,indexDessert,indexSnack
from . import views
